...
public class ProductRecommender {
  ...
  private static Product getBestProduct(ScoringStrategy scoringStrategy,ArrayList<Product> products)
  {
	  ...
	  for (int i=1;i<products.size();i++)
	  {
		  ...
		  // To obtain the score of the current_product based on given scoringStrategy by comparing scores of
		  // all the products and deciding on the best product according to that strategy
